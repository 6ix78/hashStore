...
exports.getOverViewData = async (req, res) => {
  ...
  const totalActiveAsicContarcts =
    await mAsicContract.totalActiveAsicContarcts();
  const totalAsicContarctsOnDemand =
    await mAsicContract.totalAsicContarctsOnDemand();
